                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext"><a href="http://localhost:8081/CHAFAK_ahmed/form.jsp">Ajouter Etudiants</a></</span>
                               ...
                               <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-receipt"></i><b>B</b></span>
                                        <span class="pcoded-mtext"><a href="http://localhost:8081/CHAFAK_ahmed/AjouterLivre.jsp">Ajouter livre</a></span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
                             ...
                             <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-receipt"></i><b>B</b></span>
                                        <span class="pcoded-mtext"><a href="http://localhost:8081/CHAFAK_ahmed/forml.jsp">Liste livre</a></span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
